        ...
        <div className='register-container'>
            <div className='register-content'>
                ...
                <div className='register-three-value-wrapper'>
                    ...
                    {
                        state.error ?
                            <p className='register-error color-gray'>The email you specified is in use, please use a different one.</p> :
                            <></>
                    }
                </div>
                ...
                <p className='register-text-sm color-gray'>
                    ...
                    className='register-link color-blue'>Privacy Policy</span>, including <span
                    className='register-link color-blue'>Cookie use</span>. Social may use your contact information,
                    ...
                    className='register-link color-blue'>Learn more</span>. Others will be able to find you by email or phone
